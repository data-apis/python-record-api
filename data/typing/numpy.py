...
def array(_0, _0=..., /, *, dtype=..., ndmin: int=..., copy: bool=..., order: Literal[('C', 'F', 'K')]=...):
...
def loadtxt(fname: Literal[('/Users/saul/Downloads/scikit-image-0.17.0/skimage/',)], dtype: list[tuple[(Literal[('b1', 'pair', '1', 'a1', 'L1')], list)]]):
    'usage.skimage: 1'
...
def pad(array: Union[(numpy.ndarray, list[int], list[list[int]])], pad_width, mode: Union[(Literal[('constant',)], Callable, Literal[('mean',)], Literal[('reflect', 'edge', 'linear_ramp', 'median', 'mean', 'minimum', 'constant', 'maximum', 'symmetric', 'wrap')], Literal[('edge',)])]=...):
    'usage.skimage: 126'
