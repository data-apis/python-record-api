...
def arange(
    _0: Union[(numpy.int64, dask.array.core.Array, numpy.float64, float, int)],
    _1: Union[(numpy.float64, int, float, numpy.int64)] = ...,
    _2: Union[(None, numpy.float64, float, int)] = ...,
    _3: list[numpy.uint8] = ...,
    /,
    *,
    dtype: Union[(numpy.dtype, list[int], list, list[numpy.int64])] = ...,
):
...
def linspace(
    ...
    stop: Union[(numpy.int64, numpy.float64, float, numpy.float32, int)],
    num: int,
    dtype: list = ...,
    endpoint: bool = ...,
):
...
def add(
    _0: numpy.ndarray,
    _1: Union[(tuple[(int, int, int)], numpy.ndarray, float, int, tuple[(int, int)])],
    /,
    *,
    dtype: list = ...,
):
...
def log(
    _0: Union[(numpy.ndarray, dask.array.core.Array, numpy.float64, float, int)], /
):
    "usage.sample_usage: 1\nusage.skimage: 19"
...
def sum(
    a: Union[
        (tuple[(int, int, int)], tuple[(int, int)], numpy.ndarray, list[numpy.ndarray])
    ],
    ...
    tup: Union[
        (
            ...
            tuple[
                (
                    Union[
                        (list[numpy.int64], list[Union[(int, float)]], numpy.ndarray)
                    ],
                    Union[
                        (list[numpy.int64], list[Union[(int, float)]], numpy.ndarray)
                    ],
...
def multiply(
    ...
    *,
    out: numpy.ndarray = ...,
    dtype: Union[(list[numpy.float32], numpy.dtype, list, list[numpy.float64])] = ...,
):
    "usage.skimage: 25"


def reshape(
    a: Union[(list[int], numpy.ndarray)], newshape, order: Literal[("F",)] = ...
):
    "usage.skimage: 43"
...
def amin(
    a: Union[(list[numpy.int64], list[int], tuple[(int, int)], numpy.ndarray)],
...
def amax(
    a,
    axis: Union[(tuple[(int, int, int)], tuple[(int, int)], int)] = ...,
    keepdims: bool = ...,
):
    "usage.skimage: 105"
...
def hypot(
    _0: Union[(numpy.float64, int, numpy.ndarray)],
    _1: Union[(numpy.float64, int, numpy.ndarray)],
    /,
):
    "usage.skimage: 13"
...
def arctan2(
    _0: Union[(numpy.float64, numpy.int64, numpy.ndarray)],
    _1: Union[(numpy.float64, numpy.int64, numpy.ndarray)],
    /,
):
    "usage.skimage: 8"
...
def where(
    _0: Union[(numpy.bool_, numpy.ndarray, dask.array.core.Array)],
    _1: Union[(numpy.float64, int, float, numpy.ndarray)] = ...,
    _2: Union[(numpy.float64, int, numpy.ndarray)] = ...,
    /,
):
    "usage.skimage: 26"
...
def ascontiguousarray(
    a: Union[(list[float], list[int], list[Union[(int, float)]], numpy.ndarray)],
    dtype: Union[(list[bool], numpy.dtype, list)] = ...,
):
    "usage.skimage: 67"
...
def can_cast(
    _0: Union[(numpy.dtype, int, numpy.ndarray, float)],
...
def full(
    shape: Union[
        (tuple[(int, ...)], tuple[(int, int)], int, numpy.ndarray, tuple[(int,)])
    ],
    fill_value,
    dtype=...,
):
...
def loadtxt(
    ...
    dtype: list[tuple[(Literal[("pair", "b1", "L1", "a1", "1")], list)]],
):
    "usage.skimage: 1"


def logical_and(
    _0: Union[(numpy.bool_, numpy.ndarray)], _1: Union[(numpy.bool_, numpy.ndarray)], /
):
    "usage.skimage: 13"
...
def maximum(
    _0: Union[
        (tuple[(int, int)], int, numpy.ndarray, tuple[(int, int, int)], numpy.float64)
    ],
    _1: Union[(int, tuple[(int, int)], numpy.ndarray, tuple[(int, int, int)])],
    /,
    *,
    out: numpy.ndarray = ...,
...
def minimum(
    _0: Union[(tuple[(int, int, int)], tuple[(int, int)], numpy.ndarray)],
    _1: Union[(tuple[(int, int, int)], tuple[(int, int)], float, numpy.ndarray)],
    /,
):
    "usage.skimage: 9"
...
def transpose(
    a,
    axes: Union[
        (tuple[(int, int, int)], tuple[(int, int, int, int)], list[int], numpy.ndarray)
    ] = ...,
):
    "usage.skimage: 21"
...
def pad(
    array: Union[(list[list[int]], list[int], numpy.ndarray)],
    pad_width,
    mode: Union[
        (
            Literal[("mean",)],
...
def mean(
    a: Union[(list[numpy.float64], numpy.ndarray, dask.array.core.Array)],
    axis: Union[(tuple[(int, int)], int)] = ...,
    dtype: list = ...,
):
    "usage.skimage: 61"
...
def allclose(
    a: Union[(list[numpy.float64], numpy.float64, list[int], numpy.ndarray)],
    b,
...
def indices(
    dimensions: tuple[(Union[(int, numpy.int64)], ...)],
    dtype: list[numpy.float64] = ...,
):
    "usage.skimage: 6"
...
def tile(
    A: Union[(list[int], tuple[(int, int)], numpy.ndarray)],
    reps: Union[
        (tuple[(int, ...)], tuple[(int, int, int, int)], tuple[(int, int)], list[int])
    ],
):
    "usage.skimage: 15"
...
def array_equal(
    a1: Union[(list[int], numpy.ndarray, tuple[(float, float, float)])],
    a2: Union[(tuple[(int, int, int)], numpy.ndarray)],
):
    "usage.skimage: 5"
...
def in1d(
    ...
    ar2: Union[(tuple[(int, int)], numpy.ndarray)],
):
    "usage.skimage: 2"
...
class ndarray:
    ...
    shape: Union[
        (tuple[(int, int)], tuple[(int,)], numpy.ndarray, tuple[(int, ...)])
    ] = ...
    ndim = ...
    dtype = ...
    size = ...
    ...
    def astype(
        self,
        _0: Union[(list[numpy.int16], numpy.dtype, list[numpy.uint8], list)],
        /,
        *,
        copy: bool = ...,
    ):
...
class ufunc:
    @classmethod
    def reduce(
        _0: Callable, _1: Union[(list[numpy.ndarray], tuple[(int,)], numpy.ndarray)], /
    ):
        "usage.sample_usage: 1\nusage.skimage: 6"
